      ...
      if (err1 && err1.code === "NotFound") {
        ...
        s3.putObject(params, (err2, _data2) => {
          if (err2) {
            ...
            // Use the central error modal so the full AWS error is visible
            SharedService.showError(params, err2);
          } else {
        ...
        // Show full AWS error details in the shared error modal
        SharedService.showError(params, err1);
      } else {
        bootbox.alert(
          `Error: folder or object already exists at ${params.Key}`
        );
      }
    });
  };
